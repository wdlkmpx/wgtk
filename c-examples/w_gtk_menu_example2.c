...
copy_callback (gpointer menuitem)
{
...
paste_callback (gpointer menuitem)
{
...
**/
static void shape_callback (gpointer menuitem, const char *radio_id)
{
    printf ("Shape is set to %s.\n", radio_id);
}


static void // Callback function for the about action
///about_callback (GSimpleAction *simple, GVariant *parameter, gpointer user_data)
about_callback (gpointer menuitem)
{
...
new_callback (gpointer menuitem)
{
...
quit_callback (gpointer menuitem)
{
...
**/
static void state_callback (gpointer menuitem, const char *radio_id)
{
    printf ("State is set to %s.\n", radio_id);
}
...
**/
static void awesome_callback (gpointer menuitem, gboolean is_checked)
{
    if (!is_checked)
        g_print ("You unchecked \"Awesome\"\n");
    else
...
static void activate (GtkApplication *app, gpointer user_data)
{
    ...
    menuitem.radio_cb    = shape_callback;
    w_gtk_menuitem_new (&menuitem);
    ...
    menuitem.radio_cb    = state_callback;
    w_gtk_menuitem_new (&menuitem);
    // Choices->Off
    menuitem.parent_menu = menu_choices[2];
    ...
    menuitem.checked_cb = awesome_callback;
    w_gtk_menuitem_new (&menuitem);
