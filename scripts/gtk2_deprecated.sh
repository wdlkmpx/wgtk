...
# 2.24.0
gtk2_deprecated_list='gtk_about_dialog_get_name
...
gdk2_deprecated_list='gdk_bitmap_create_from_data
gdk_bitmap_ref
gdk_bitmap_unref
...
(
   echo "$gtk2_deprecated_list"
   echo "$gdk2_deprecated_list"
) > /tmp/gtk2.deprecated.list

for i in $files
do
   grep -f /tmp/gtk2.deprecated.list -H -n "$i"
done
